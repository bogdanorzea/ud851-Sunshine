...
//      COMPLETED (8) Use mDetailBinding to display the date
        mDetailBinding.primary.date.setText(dateText);
...
//      COMPLETED (15) Create the content description for the description for a11y
        String weatherContentDescription = getString(R.string.a11y_forecast, description);
...
//      COMPLETED (9) Use mDetailBinding to display the description and set the content description
        ...
        mDetailBinding.primary.weatherDescription.setText(description);
        mDetailBinding.primary.weatherDescription.setContentDescription(weatherContentDescription);

        /****************
         * Weather icon *
         ****************/
//      COMPLETED (7) Display the weather icon using mDetailBinding
        mDetailBinding.primary.weatherIcon.setBackgroundResource(
...
//      COMPLETED (16) Set the content description of the icon to the same as the weather description a11y text
        mDetailBinding.primary.weatherIcon.setContentDescription(weatherContentDescription);
...
//      COMPLETED (17) Create the content description for the high temperature for a11y
        String highTempContentDescription = getString(R.string.a11y_high_temp, highString);
...
//      COMPLETED (10) Use mDetailBinding to display the high temperature and set the content description
        ...
        mDetailBinding.primary.highTemperature.setText(highString);
        mDetailBinding.primary.highTemperature.setContentDescription(highTempContentDescription);
...
//      COMPLETED (18) Create the content description for the low temperature for a11y
        String lowTempContentDescription = getString(R.string.a11y_low_temp, lowString);
...
//      COMPLETED (11) Use mDetailBinding to display the low temperature and set the content description
        ...
        mDetailBinding.primary.lowTemperature.setText(lowString);
        mDetailBinding.primary.lowTemperature.setContentDescription(lowTempContentDescription);
...
//      COMPLETED (20) Create the content description for the humidity for a11y
        String humidityContentDescription = getString(R.string.a11y_humidity, humidityString);
...
//      COMPLETED (12) Use mDetailBinding to display the humidity and set the content description
        ...
        mDetailBinding.extra.humidity.setText(humidityString);
        mDetailBinding.extra.humidity.setContentDescription(humidityContentDescription);

//      COMPLETED (19) Set the content description of the humidity label to the humidity a11y String
        mDetailBinding.extra.humidityLabel.setContentDescription(humidityContentDescription);
...
//      COMPLETED (21) Create the content description for the wind for a11y
        String windContentDescription = getString(R.string.a11y_wind, windString);
...
//      COMPLETED (13) Use mDetailBinding to display the wind and set the content description
        ...
        mDetailBinding.extra.wind.setText(windString);
        mDetailBinding.extra.wind.setContentDescription(windContentDescription);

//      COMPLETED (22) Set the content description of the wind label to the wind a11y String
        mDetailBinding.extra.windLabel.setContentDescription(windContentDescription);
...
//      COMPLETED (23) Create the content description for the pressure for a11y
        String pressureContentDescription = getString(R.string.a11y_pressure, pressureString);
...
//      COMPLETED (14) Use mDetailBinding to display the pressure and set the content description
        ...
        mDetailBinding.extra.pressure.setText(pressureString);
        mDetailBinding.extra.pressure.setContentDescription(pressureContentDescription);

//      COMPLETED (24) Set the content description of the pressure label to the pressure a11y String
        mDetailBinding.extra.pressureLabel.setContentDescription(pressureContentDescription);
