...
public class SunshineSyncTask {
    ...
    private static long ellapsedTimeSinceLastNotification;
    ...
    synchronized public static void syncWeather(Context context) {
        ...
        try {
            ...
            if (weatherValues != null && weatherValues.length != 0) {
                ...
                boolean notificationSentBeforeToday = false;
                ellapsedTimeSinceLastNotification =
                        SunshinePreferences.getEllapsedTimeSinceLastNotification(context);

                if (ellapsedTimeSinceLastNotification >= DateUtils.DAY_IN_MILLIS){
                    notificationSentBeforeToday = true;
                }

//              COMPLETED (15) If more than a day have passed and notifications are enabled, notify the user
                if (notificationEnabled && notificationSentBeforeToday){
