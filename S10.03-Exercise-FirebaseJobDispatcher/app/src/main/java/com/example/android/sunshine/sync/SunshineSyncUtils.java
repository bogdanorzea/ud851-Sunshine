...
public class SunshineSyncUtils {
    ...
    public static final String SUNSHINE_SYNC_TAG = "sunshine_sync_tag";

//  COMPLETED (12) Create a method to schedule our periodic weather sync
    synchronized private static void scheduleWeatherSync(Context context){
        ...
        Job myJob = dispatcher.newJobBuilder()
                ...
                .setTrigger(Trigger.executionWindow(0, SUNSHINE_SYNC_INTERVAL_SECONDS))
                .setRecurring(true)
