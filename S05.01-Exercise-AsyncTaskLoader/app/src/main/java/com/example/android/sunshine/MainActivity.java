...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    private final int WEATHER_LOADER = 23;
    ...
    private void loadWeatherData() {
        ...
        args.putString(WEATHER_LOCATION, location);

        if (loaderManager.getLoader(WEATHER_LOADER) == null) {
            loaderManager.initLoader(WEATHER_LOADER, args, this);
        } else {
            loaderManager.restartLoader(WEATHER_LOADER, args, this);
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            ...
            loaderManager.destroyLoader(WEATHER_LOADER);
            loadWeatherData();
            return true;
        }
