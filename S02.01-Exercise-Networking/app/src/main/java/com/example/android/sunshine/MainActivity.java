...
import static com.example.android.sunshine.R.id.tv_weather_data;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData() {
        String preferredWeatherLocation = "Paris";
        URL queryUrl = null;
        try {
            queryUrl = NetworkUtils.buildUrl(preferredWeatherLocation);
