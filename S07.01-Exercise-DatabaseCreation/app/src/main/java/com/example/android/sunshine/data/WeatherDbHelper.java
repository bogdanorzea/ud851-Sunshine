...
public class WeatherDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        final String PRIMARY_KEY = " PRIMARY KEY AUTOINCREMENT";

        String SQL_CREATE_WEATHER_TABLE =
                "CREATE TABLE " + WeatherEntry.TABLE_NAME + "("+
                WeatherEntry._ID + TYPE_INTEGER + PRIMARY_KEY + SEPARATOR +
                WeatherEntry.COLUMN_DATE + TYPE_INTEGER + SEPARATOR +
                WeatherEntry.COLUMN_WEATHER_ID + TYPE_INTEGER + SEPARATOR +
                WeatherEntry.COLUMN_MIN_TEMP + TYPE_REAL + SEPARATOR +
                WeatherEntry.COLUMN_MAX_TEMP + TYPE_REAL + SEPARATOR +
                WeatherEntry.COLUMN_HUMIDITY + TYPE_REAL + SEPARATOR +
                WeatherEntry.COLUMN_PRESSURE + TYPE_REAL + SEPARATOR +
                WeatherEntry.COLUMN_WIND_SPEED + TYPE_REAL + SEPARATOR +
                WeatherEntry.COLUMN_DEGREES + TYPE_REAL + ");";
